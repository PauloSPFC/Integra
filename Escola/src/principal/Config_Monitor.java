...
public class Config_Monitor extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Config_Monitor frame = new Config_Monitor();
	...
	public Config_Monitor() {
		...
		Btn_minimize.setIcon(new ImageIcon(Config_Monitor.class.getResource("/Imagens/Bot\u00F5es/minimize.png")));
		Btn_minimize.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent arg0) {
				Btn_minimize.setIcon(new ImageIcon(Config_Monitor.class.getResource("/Imagens/Bot\u00F5es/minimize_hover.png")));
		...
		Btn_fechar.setIcon(new ImageIcon(Config_Monitor.class.getResource("/Imagens/Bot\u00F5es/close.png")));
		...
		Btn_fechar.addMouseListener(new MouseAdapter() {
			...
			@Override
			public void mouseEntered(MouseEvent arg0) {
				Btn_fechar.setIcon(new ImageIcon(Config_Monitor.class.getResource("/Imagens/Bot\u00F5es/close_hover.png")));
		...
		Lbl_mousemove.addMouseMotionListener(new MouseMotionAdapter() {
			...
			public void mouseDragged(MouseEvent e) {
		        ...
		        Config_Monitor.this.setLocation(x - xx, y - xy);
			}
		});
		...
		Fundo.setIcon(new ImageIcon(Config_Monitor.class.getResource("/Imagens/Principal/config_escola.jpg")));
		...
		btn_excluir.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				dispose();
				Excl_monitor ex = new Excl_monitor();
