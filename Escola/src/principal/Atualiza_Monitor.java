...
public class Atualiza_Monitor extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Atualiza_Monitor frame = new Atualiza_Monitor();
	...
	public Atualiza_Monitor() {
		...
		Btn_minimize.setIcon(new ImageIcon(Atualiza_Monitor.class.getResource("/Imagens/Bot\u00F5es/minimize.png")));
		Btn_minimize.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent arg0) {
				Btn_minimize.setIcon(new ImageIcon(Atualiza_Monitor.class.getResource("/Imagens/Bot\u00F5es/minimize_hover.png")));
		...
		Btn_fechar.setIcon(new ImageIcon(Atualiza_Monitor.class.getResource("/Imagens/Bot\u00F5es/close.png")));
		...
		Btn_fechar.addMouseListener(new MouseAdapter() {
			...
			@Override
			public void mouseEntered(MouseEvent arg0) {
				Btn_fechar.setIcon(new ImageIcon(Atualiza_Monitor.class.getResource("/Imagens/Bot\u00F5es/close_hover.png")));
		...
		Btn_voltar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				dispose();
				Config_Monitor ce = new Config_Monitor();
		...
		Lbl_mousemove.addMouseMotionListener(new MouseMotionAdapter() {
			...
			public void mouseDragged(MouseEvent e) {
		        ...
		        Atualiza_Monitor.this.setLocation(x - xx, y - xy);
			}
		});
		...
		Inp_matricula.setBounds(297, 489, 167, 29);
		...
		Inp_telefone.setBounds(34, 489, 183, 29);
		...
		Inp_cidade.setBounds(34, 426, 183, 29);
		...
		Inp_estado.setBounds(297, 426, 167, 29);
		...
		Inp_bairro.setBounds(297, 358, 167, 29);
		...
		Inp_nro.setBounds(36, 358, 112, 29);
		...
		Inp_nome.setBounds(36, 164, 430, 29);
		Container_principal.add(Inp_nome);
		Inp_nome.setColumns(10);
		
		JLabel Btn_cad = new JLabel("");
		Btn_cad.setIcon(new ImageIcon(Atualiza_Monitor.class.getResource("/Imagens/Bot\u00F5es/btn_att.png")));
		...
		Btn_cad.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				Monitor m = new Monitor(matricula,cpf,nome,tel,rua,nro,bairro,cidade);
				
				if (md.checkCadastro(cpf) == false) {
					cadastra = false;
				}
				...
				if (cadastra == false) {
					...
					Login_Monitor le = new Login_Monitor();
		...
		Fundo.setIcon(new ImageIcon(Atualiza_Monitor.class.getResource("/Imagens/Principal/atualiza_monitor.jpg")));
