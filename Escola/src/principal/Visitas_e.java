...
public class Visitas_e extends JFrame {
	...
	public Visitas_e() {	
		...
		Btn_minimize.setIcon(new ImageIcon(Visitas_e.class.getResource("/Imagens/Bot\u00F5es/minimize.png")));
		Btn_minimize.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent arg0) {
				Btn_minimize.setIcon(new ImageIcon(Visitas_e.class.getResource("/Imagens/Bot\u00F5es/minimize_hover.png")));
		...
		Btn_fechar.setIcon(new ImageIcon(Visitas_e.class.getResource("/Imagens/Bot\u00F5es/close.png")));
		...
		Btn_fechar.addMouseListener(new MouseAdapter() {
			...
			@Override
			public void mouseEntered(MouseEvent arg0) {
				Btn_fechar.setIcon(new ImageIcon(Visitas_e.class.getResource("/Imagens/Bot\u00F5es/close_hover.png")));
		...
		Lbl_mousemove.addMouseMotionListener(new MouseMotionAdapter() {
			...
			public void mouseDragged(MouseEvent e) {
		        ...
		        Visitas_e.this.setLocation(x - xx, y - xy);
			}
		});
		...
		btn_ant.setIcon(new ImageIcon(Visitas_e.class.getResource("/Imagens/Principal/btn_ant.png")));
		btn_ant.setBounds(23, 560, 192, 48);
		Container_principal.add(btn_ant);
		btn_prox.setIcon(new ImageIcon(Visitas_e.class.getResource("/Imagens/Principal/btn_prox.png")));
		...
		Fundo.setIcon(new ImageIcon(Visitas_e.class.getResource("/Imagens/Principal/confirm_cons.jpg")));
		...
		btn_consultar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				if (cadastra == false) {
					...
					professor.setBounds(108, 511, 410, 48);
					...
					escola.setBounds(637, 209, 343, 48);
					...
					alunos.setBounds(624, 351, 356, 48);
					...
					trajeto.setBounds(327, 206, 38, 48);
						...
						btn_prox.addMouseListener(new MouseAdapter() {
							...
							public void mouseClicked(MouseEvent arg0) {	
								...
								if (click_count < tamanho) {
									int codigo = vd.getLista(matricula).get(click_count3).getCod_visita();
									int traj = vd.getLista(matricula).get(click_count3).getCod_trajeto();
									String mon = md.getNome(vd.getLista(matricula).get(click_count3).getMonitor());
									String prof = pd.getNome(vd.getLista(matricula).get(click_count3).getProfessor());
									String dat = vd.getLista(matricula).get(click_count3).getData_visita();
									String hr = vd.getLista(matricula).get(click_count3).getHorario_visita();
									int aln = vd.getLista(matricula).get(click_count3).getNro_alunos();
					...
					JLabel Fundo2 = new JLabel("");
					Fundo2.setIcon(new ImageIcon(Visitas_e.class.getResource("/Imagens/Principal/visitas.jpg")));
					Fundo2.setBounds(10, 18, 1000, 598);
					Container_principal.add(Fundo2);
				}
			}
