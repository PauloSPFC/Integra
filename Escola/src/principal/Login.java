...
public class Login extends JFrame {
	...
	public Login() {
		...
		Btn_minimize.setIcon(new ImageIcon(Login.class.getResource("/Imagens/Bot\u00F5es/minimize.png")));
		Btn_minimize.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent arg0) {
				Btn_minimize.setIcon(new ImageIcon(Login.class.getResource("/Imagens/Bot\u00F5es/minimize_hover.png")));
		...
		Btn_fechar.setIcon(new ImageIcon(Login.class.getResource("/Imagens/Bot\u00F5es/close.png")));
		...
		Btn_fechar.addMouseListener(new MouseAdapter() {
			...
			@Override
			public void mouseEntered(MouseEvent arg0) {
				Btn_fechar.setIcon(new ImageIcon(Login.class.getResource("/Imagens/Bot\u00F5es/close_hover.png")));
		...
		Btn_voltar.setIcon(new ImageIcon(Login.class.getResource("/Imagens/Bot\u00F5es/voltar.png")));
		Btn_voltar.addMouseListener(new MouseAdapter() {
			...
			@Override
			public void mouseEntered(MouseEvent arg0) {
				Btn_voltar.setIcon(new ImageIcon(Login.class.getResource("/Imagens/Bot\u00F5es/voltar_hover.png")));
		...
		Ver.setIcon(new ImageIcon(Login.class.getResource("/Imagens/Bot\u00F5es/ver.png")));
		...
		Ver.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				if (click_count %2 == 0) {
					...
					Ver.setIcon(new ImageIcon(Login.class.getResource("/Imagens/Bot\u00F5es/desver.png")));
				} else {
		...
		Btn_Entrar.setIcon(new ImageIcon(Login.class.getResource("/Imagens/Botões/entrar_p.png")));
		...
		Btn_Entrar.addMouseListener(new MouseAdapter() {
			...
			@Override
			public void mouseEntered(MouseEvent arg0) {
				Btn_Entrar.setIcon(new ImageIcon(Login.class.getResource("/Imagens/Bot\u00F5es/entrar_hover.png")));
		...
		Btn_Cadastrar.setIcon(new ImageIcon(Login.class.getResource("/Imagens/Botões/cadastrar.png")));
		...
		Btn_Cadastrar.addMouseListener(new MouseAdapter() {
			...
			@Override
			public void mouseEntered(MouseEvent arg0) {
				Btn_Cadastrar.setIcon(new ImageIcon(Login.class.getResource("/Imagens/Bot\u00F5es/cadastrar_hover.png")));
				setCursor( Cursor.getPredefinedCursor( Cursor.HAND_CURSOR));
			}
			@Override
		...
		Fundo.setIcon(new ImageIcon(Login.class.getResource("/Imagens/Cenas/login_professor.jpg")));
