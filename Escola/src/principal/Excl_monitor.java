...
public class Excl_monitor extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Excl_monitor frame = new Excl_monitor();
	...
	public Excl_monitor() {
		...
		Btn_minimize.setIcon(new ImageIcon(Excl_monitor.class.getResource("/Imagens/Bot\u00F5es/minimize.png")));
		Btn_minimize.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent arg0) {
				Btn_minimize.setIcon(new ImageIcon(Excl_monitor.class.getResource("/Imagens/Bot\u00F5es/minimize_hover.png")));
		...
		Btn_fechar.setIcon(new ImageIcon(Excl_monitor.class.getResource("/Imagens/Bot\u00F5es/close.png")));
		...
		Btn_fechar.addMouseListener(new MouseAdapter() {
			...
			@Override
			public void mouseEntered(MouseEvent arg0) {
				Btn_fechar.setIcon(new ImageIcon(Excl_monitor.class.getResource("/Imagens/Bot\u00F5es/close_hover.png")));
		...
		Lbl_mousemove.addMouseMotionListener(new MouseMotionAdapter() {
			...
			public void mouseDragged(MouseEvent e) {
		        ...
		        Excl_monitor.this.setLocation(x - xx, y - xy);
			}
		});
		...
		btn_excluir.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				if (md.checkCadastro(matricula) == false) {	
					cadastra = false;			
				}
				...
				if (cadastra == false) {
					...
					vd.removerMonitor(matricula);
					md.removerMatricula(matricula);
					dispose();
					Acesso a = new Acesso();
		...
		Fundo.setIcon(new ImageIcon(Excl_monitor.class.getResource("/Imagens/Principal/Excl_m.jpg")));
