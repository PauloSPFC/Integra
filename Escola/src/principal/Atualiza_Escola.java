...
public class Atualiza_Escola extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Atualiza_Escola frame = new Atualiza_Escola();
	...
	public Atualiza_Escola() {
		...
		Btn_minimize.setIcon(new ImageIcon(Atualiza_Escola.class.getResource("/Imagens/Bot\u00F5es/minimize.png")));
		Btn_minimize.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent arg0) {
				Btn_minimize.setIcon(new ImageIcon(Atualiza_Escola.class.getResource("/Imagens/Bot\u00F5es/minimize_hover.png")));
		...
		Btn_fechar.setIcon(new ImageIcon(Atualiza_Escola.class.getResource("/Imagens/Bot\u00F5es/close.png")));
		...
		Btn_fechar.addMouseListener(new MouseAdapter() {
			...
			@Override
			public void mouseEntered(MouseEvent arg0) {
				Btn_fechar.setIcon(new ImageIcon(Atualiza_Escola.class.getResource("/Imagens/Bot\u00F5es/close_hover.png")));
		...
		Lbl_mousemove.addMouseMotionListener(new MouseMotionAdapter() {
			...
			public void mouseDragged(MouseEvent e) {
		        ...
		        Atualiza_Escola.this.setLocation(x - xx, y - xy);
			}
		});
		...
		Inp_matricula.setBounds(297, 483, 167, 29);
		...
		Inp_telefone.setBounds(34, 483, 183, 29);
		...
		Btn_cad.setIcon(new ImageIcon(Atualiza_Escola.class.getResource("/Imagens/Bot\u00F5es/btn_att.png")));
		...
		Fundo.setIcon(new ImageIcon(Atualiza_Escola.class.getResource("/Imagens/Principal/atualiza_escola.jpg")));
